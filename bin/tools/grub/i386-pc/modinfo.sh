...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/i586-alpine-linux-musl/15.2.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
